  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden space-y-4">
      ...
      <div className="flex-1 flex gap-4 overflow-hidden">
        ...
        {/* To Do Column */}
        <div className="flex-1 flex flex-col gap-3.5 h-full overflow-hidden bg-[#050608]/20 border border-[var(--border-primary)] backdrop-blur-xl rounded-2xl p-4 shadow-lg">
        ...
        <div className="flex-1 flex flex-col gap-3.5 h-full overflow-hidden bg-[#050608]/20 border border-[var(--border-primary)] backdrop-blur-xl rounded-2xl p-4 shadow-lg">
          <div className="flex justify-between items-center px-1 shrink-0 select-none">
            ...
            <span className="text-[9px] font-mono font-black text-blue-400 bg-blue-950/20 border border-blue-500/20 px-2.5 py-0.5 rounded-lg">
        ...
        <div className="flex-1 flex flex-col gap-3.5 h-full overflow-hidden bg-[#050608]/20 border border-[var(--border-primary)] backdrop-blur-xl rounded-2xl p-4 shadow-lg">
          <div className="flex justify-between items-center px-1 shrink-0 select-none">
            ...
            <span className="text-[9px] font-mono font-black text-emerald-400 bg-emerald-950/20 border border-emerald-500/20 px-2.5 py-0.5 rounded-lg">
...
function KanbanCard({ 
  ...
  const borderClass = isCompleted 
    ? 'border-[var(--border-primary)] bg-[var(--bg-card)]/50 opacity-80' 
    : isActive 
    ? 'bg-blue-950/10 border-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.05)]' 
    : 'bg-[var(--bg-card)] border-[var(--border-primary)] shadow-md';
  ...
  return (
    <motion.div
      ...
      className={`border rounded-2xl p-5 flex flex-col space-y-3.5 text-left hover:border-blue-500/20 transition-all duration-300 relative overflow-hidden group ${borderClass}`}
    >
      ...
      <div className="flex justify-between items-start gap-2 relative z-10 select-none">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-[9px] font-black text-blue-400 uppercase tracking-widest truncate max-w-[120px]">
      ...
      {/* Reasoning log */}
      {ticket.thought && (
        <div className="bg-[var(--bg-primary)]/50 border border-[var(--border-primary)] p-3 rounded-xl text-[10px] font-mono text-slate-350 leading-relaxed shadow-inner border-l-2 border-l-blue-500/40 relative">
          <span className="text-[8px] font-black text-blue-400 uppercase tracking-widest block mb-1">Active Reasoning</span>
      ...
      {isActive && (
        <div className="pt-1 shrink-0 select-none">
          <div className="w-full bg-blue-950/40 rounded-full h-1.5 mb-1.5 overflow-hidden border border-blue-500/10">
            <div className="bg-blue-500 h-full rounded-full animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.4)]" style={{ width: '65%' }}></div>
          </div>
          <span className="text-[9.5px] text-blue-400 font-extrabold uppercase tracking-wider flex items-center gap-1">
      ...
      {hasOutput && (
        <div className="pt-2 border-t border-[var(--border-primary)] flex justify-end shrink-0 select-none">
          <button
            ...
            className="h-7 px-3 rounded-lg bg-blue-950/20 border border-blue-500/20 hover:bg-blue-600/15 hover:border-blue-500/40 text-blue-400 text-[8px] font-black uppercase tracking-widest flex items-center gap-1.5 transition-colors cursor-pointer shadow-md"
          >
